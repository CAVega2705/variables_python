...
nombre_completo_padre = str(input("Ingrese apellido y nombre se su padre:"))
nombre_completo_madre = str(input("Ingrese apellido y nombre de su madre:"))
nombre_hijo = str(input("ingrese su sólo nombre:"))

apellido_padre, nombre_padre = nombre_completo_padre.split(" ")
apellido_madre, nombre_madre = nombre_completo_madre.split(" ")
nombre_completo_hijo = apellido_padre + " " + apellido_madre + " " + nombre_hijo

print("Su nombre completo es: {}".format(nombre_completo_hijo))
